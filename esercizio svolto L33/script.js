...
let posizione = frase.indexOf(parola);
...
let colori = ["rosso", "verde", "giallo", "blu"];
let indiceCasuale = Math.floor(Math.random() * 4);
let colorePescato = colori[indiceCasuale];
console.log(colorePescato);
...
let mese = oggi.getMonth() + 1; // Aggiungiamo 1 perché i mesi partono da 0
...
let nomeGiorno = giorniSettimana[giornoCorrente];
